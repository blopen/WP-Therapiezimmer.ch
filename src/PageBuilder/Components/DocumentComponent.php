...
use Cubetech\Cards\DocumentCard;
 ...
 * @since 1.0.0
 */
class DocumentComponent extends BaseComponent implements IStringRenderable
{
    ...
    {
        parent::__construct('Document', $postId, $index, $containerClass);
        $this->title = $this->getComponentField('title');
        $this->posts = $this->getComponentRepeaterField("documents_repeater", ['post_type' => "documents"]);
        $this->createCards();
    }
    ...
    private function createCards()
    {
        ...
        foreach ($this->posts as $post) {
            $cards[] = new DocumentCard($post->crews);
        }
        $this->cards = $cards;
    }
